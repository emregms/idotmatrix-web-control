...
# Orijinal Protokol Notları (Tersine Mühendislik)

> **Not:** Bu dosya, orijinal [idotmatrix](https://github.com/8none1/idotmatrix) deposundaki `README.md` dosyasının içeriğidir. Cihazın Bluetooth protokolü hakkında teknik detaylar ve tersine mühendislik notlarını içerir.
